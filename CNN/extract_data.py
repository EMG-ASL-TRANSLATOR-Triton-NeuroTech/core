...
def extract_and_downsample_emg(
        ...
        output_rows: int = 169  # Default: 5000 samples / 30ms windows ≈ 167 windows
) -> np.ndarray:
...
if __name__ == "__main__":
    file_path = "../CSV/Test-Ricardo_Closed-Hand.csv"
    ...
    try:
        ...
        np.savetxt('emg_data/gesture2_sample2.csv', emg_data, delimiter=',', fmt='%.6f',
