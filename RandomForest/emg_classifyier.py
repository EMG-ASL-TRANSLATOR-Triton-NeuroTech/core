...
CSV_PATH = BASE_DIR / "DATASET EMG MINDROVE" / "FORMATTED" / "subjek_FORMATTED.csv"  # Generated by prepare_emg_datasets.py
DATASET_ROOT = BASE_DIR / "DATASET EMG MINDROVE" / "FORMATTED"  # Generated by prepare_emg_datasets.py
